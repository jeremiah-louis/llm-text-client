        ...
        <div className="flex flex-col space-y-2">
          ...
          <div className="flex flex-col gap-6">
            <Input
              ...
              required
            />
            <Button type="submit" className="h-11 w-full bg-blue-500 hover:bg-blue-600" disabled={isLoading || !url.trim()}>
              {isLoading ? (
                <>
        ...
        <div className="flex flex-col h-[400px] border rounded-lg overflow-hidden">
          ...
          <form onSubmit={handleChatSubmit} className="border-t p-2">
            <div className="flex gap-2">
              ...
              />
              <Button className="bg-blue-500" type="submit" disabled={isChatLoading || !query.trim()}>
                {isChatLoading ? (
                  <Loader2 className="h-4 w-4 animate-spin" />
                ) : (
                  'Send'
